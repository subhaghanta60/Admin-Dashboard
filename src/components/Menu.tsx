        ...
        <div className="flex flex-col gap-2" key={menu.title}>
          ...
          {menu.items.map((menuitem)=> {
            if(menuitem.visible.includes(role)){
              return (
                <Link href={menuitem.href} key={menuitem.label} className="flex items.center lg:justify-start gap-4 text-gray-500 py-2 md:px-2 rounded-md hover:bg-lamaSkyLight">
